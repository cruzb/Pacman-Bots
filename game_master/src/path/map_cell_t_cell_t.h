#ifndef MAP_CELL_T_CELL_T_H
#define MAP_CELL_T_CELL_T_H

#include <inttypes.h>

typedef struct bucket_cell_t_cell_t {
    uint8_t empty;
    cell_t key;
    cell_t val;
} bucket_cell_t_cell_t;

#include "array_bucket_cell_t_cell_t.h"

typedef struct map_cell_t_cell_t {
    array_bucket_cell_t_cell_t buckets;
    size_t(*hash)(cell_t);
