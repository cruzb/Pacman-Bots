...
path_t path_get(grid_t* grid, cell_t start_cell, cell_t end_cell) {
    ...
    map_cell_t_cell_t_init(&came_from, 100, grid_cell_hash, grid_cell_match, grid_cell_new, grid_cell_new);
    map_cell_t_double_init(&g_score, 100, grid_cell_hash, grid_cell_match, grid_cell_new, grid_cell_inf_weight);
    map_cell_t_double_init(&f_score, 100, grid_cell_hash, grid_cell_match, grid_cell_new, grid_cell_inf_weight);
