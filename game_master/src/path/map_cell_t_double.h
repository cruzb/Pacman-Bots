#ifndef MAP_CELL_T_DOUBLE_H
#define MAP_CELL_T_DOUBLE_H

#include <inttypes.h>

typedef struct bucket_cell_t_double {
    uint8_t empty;
    cell_t key;
    double val;
} bucket_cell_t_double;

#include "array_bucket_cell_t_double.h"

typedef struct map_cell_t_double {
    array_bucket_cell_t_double buckets;
    size_t(*hash)(cell_t);
